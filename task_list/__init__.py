...
# URLS
from .views import IndexView, TaskRestView, UserRestView, UploadIndexView,UploadView
...
app.add_url_rule('/upload-index/', view_func=UploadIndexView.as_view('upload_index'))
